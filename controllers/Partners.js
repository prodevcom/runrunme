exports.findAll = function (req, res) {
    var model = new req.app.models.PartnersDao(req.app.get('connection'));
...
exports.find = function (req, res) {
    var db = new req.app.models.PartnersDao(req.app.get('connection'));
    var conditions = {};
    if (req.param('id')) conditions.id_together_partners = req.param('id');
    var page = req.param('page') ? parseInt(req.param('page')) : 1;
    var limit = req.param('limit') ? parseInt(req.param('limit')) : 10;
    var offset = (page - 1) * limit;
